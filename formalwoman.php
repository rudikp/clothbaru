	...
	<div class="container">
		<div class="row">
  			<?php
				...
				//queryproduk
					$produk = mysql_query("SELECT * FROM produk WHERE id_jeniskelamin = 2 AND id_tipebaju = 1 ORDER BY id_produk") or die(mysql_error());
					...
					if(!isset($_GET['page']))
						...
						$sql="SELECT * FROM produk WHERE id_jeniskelamin = 2 AND id_tipebaju = 1 ORDER BY id_produk 
							  limit $mulai,$num_rec_per_page";
						$hasil=mysqli_query($con, $sql);
				//$result = mysqli_query($con,"SELECT * FROM produk WHERE id_tipebaju='1' AND id_jeniskelamin='2'");
				while($row = mysqli_fetch_array($hasil)) { ?>
					  <div class="col-sm-6 col-md-4 col-lg-3">
					    <div class="thumbnail">
					      <img src="image/<?php echo $row['foto']; ?>" style="height:250px;" alt="...">
					      <div class="caption">
...
<?php
			...
			else
			{
				...
				{
					echo "<a href=formalwoman.php?page=$hal>" . $hal . "</a> ";
				}						
			}
