  			...
  			<?php
				...
				if (mysqli_connect_errno()) {
				  echo "Failed to connect to MySQL: " . mysqli_connect_error();
					...
					//queryproduk
					$produk = mysql_query("SELECT * FROM produk WHERE id_jeniskelamin= 2 ORDER BY id_produk") or die(mysql_error());
					...
					if(!isset($_GET['page']))
						...
						$sql="SELECT * FROM produk WHERE id_jeniskelamin = 2 ORDER BY id_produk 
							  limit $mulai,$num_rec_per_page";
						$hasil=mysqli_query($con, $sql);

				//$result = mysqli_query($con,"SELECT * FROM produk WHERE id_jeniskelamin='2'");
...
<?php
			...
			else
			{
				...
				{
					echo "<a href=woman.php?page=$hal>" . $hal . "</a> ";
				}						
			}
